export const texts = {
    es: {
        ...
        skills: {
            ...
            description: 'Este portfolio fue desarrollado con React, Vite, CSS, y desplegado en Netlify.',
        },
        projects: {
        ...
        contact: {
            title: '💬 Contactame',
            description: `Si tenés alguna consulta, propuesta o por cualquier motivo, estoy a disposición!
Podés contactarme por:`,
    ...
    en: {
        ...
        skills: {
            ...
            description: 'This portfolio was developed with React, Vite, CSS, and deployed on Netlify.',
        },
        projects: {
            title: '🚀 Personal Projects',
            subtitle: 'Some of my projects',
            vestire: {
                description: 'Clothing e-commerce with test payments',
            },
            space: {
                description: 'Space tourism blog'
            },
            manager: {
                description: 'Task management app'
            },
            shoe: {
                description: 'Simple product aggregator'
            },
        },
        contact: {
            title: '💬 Contact me',
            description: `If you have any questions, proposals or for any reason, I'm available!
